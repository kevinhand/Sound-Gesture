...
import org.hermit.fftpack.RealDoubleFFT;
...
public class SPUtil {
	...
	public static double[] getAudioFeatures(short[][] data){
		...
		System.arraycopy(leftData, 0, leftData0Pad, 1024, leftData.length);
		System.arraycopy(leftData, 0, rightData0Pad, 1024, rightData.length);
